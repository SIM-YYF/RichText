    ...
    render() {
        return (
            ...
            >
                ...
                />
                <StyleModal ref={r => (this.StyleModal = r)}/>
                <ColorStyleModal ref={r => (this.ColorStyleModal = r)}/>
    ...
    _onPress(action) {
        switch (action) {
            ...
            case actions.box_text_color: //修改字体颜色
                //弹窗，选择样式
                this.ColorStyleModal._change_modal_state(true, "textColor");
                break;
            case actions.box_background_color: //修改字体背景颜色
                //弹窗，选择样式
                this.ColorStyleModal._change_modal_state(true, "backgroundColor");
                break;
